        ...
        <form action="{{ route('loginProcess') }}" class="login__form" method="POST">
            ...
            <div class="login__content">
                <div class="mb-3">
                    ...
                    <input type="text" name="email" class="login__field form-control" id="formGroupExampleInput"
                        placeholder="Enter your username here">
                </div>

                <div class="mb-3">
                    <label for="inputPassword5" class="form-label">Password</label>
                    <input type="password" name="password" id="inputPassword5" class="login__field form-control"
